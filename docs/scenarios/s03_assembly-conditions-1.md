...
1. `/json` directory: Contains 1,800 individual JSON files of unprocessed screw driving operations, each recording the complete measurement data of a single screwing process.
...
| 2     | 003_control-group-3               | 100    | No manipulations, standard reference data for comparison with other experiment groups; recorded for s03 during multiple sessions between February and June 2023 |
| 3     | 004_control-group-from-s01        | 200    | No manipulations like 001; the observations were taken from s01-001 control group, using first cycles only to maintain comparability with other experiments |
| 4     | 005_control-group-from-s02        | 100    | No manipulations like 001; the observations were taken from s02-001 control group, using first cycles only to maintain comparability with other experiments |
| 5     | 101_m4-washer-in-upper-piece      | 50     | Reduced screw insertion depth using a custom-cut polyamide washer with 4mm inner diameter; the washer was placed inside the upper part during fastening and secured together with the screw, creating controlled thread interference |
| 6     | 102_m3-washer-in-upper-piece      | 50     | Reduced screw insertion depth using a standard M3 polyamide washer; the washer was placed inside the upper part during fastening and secured together with the screw, creating controlled thread interference |
| 7     | 103_m3-half-washer-in-upper-part  | 50     | Reduced screw insertion depth and asymmetric load distribution using half of an M3 polyamide washer; the half-washer was placed inside the upper part during fastening and secured together with the screw, creating non-uniform thread engagement |
| 8     | 201_adhesive-thread               | 50     | Modified thread behavior by applying a metal adhesive to the screw tip, creating partial binding and increased resistance during fastening due to secondary material interference |
| 9     | 202_deformed-thread-1             | 100    | Damaged thread by mechanically deforming multiple thread sections, causing irregular engagement and variations in torque requirements; reforded for s03 in March 2023 |
| 10    | 203_deformed-thread-2             | 50     | Damaged thread by mechanically like 202; observations collected under similar experimental conditions but recorded three months later, in June 2023 |
| 11    | 301_material-in-the-screw-head    | 50     | Compromised tool engagement by applying melted adhesive to the Delta PT screw head, causing driver slippage during automated fastening and inconsistent torque transfer |
| 12    | 302_material-in-the-lower-part    | 50     | Inserted plastic adhesive into the lower workpiece's screw-in hole, creating higher mechanical opposition as the screw enters and rotates during tightening |
| 13    | 401_drilling-out-the-workpiece    | 50     | Reduced thread engagement by enlarging the pilot holes in the lower part with a fine drill, decreasing available material for thread formation and weakening the connection |
| 14    | 402_shortening-the-screw-1        | 50     | Caused rotation angle tolerance deviations by removing approximately two thread turns and the screw tip using a saw, reducing total length of thread engagement and tip |
| 15    | 403_shortening-the-screw-2        | 50     | Caused rotation angle tolerance deviations like 402; observations collected under similar experimental conditions but recorded three months later, in September 2023 |
...
| 11    | 301_material-in-the-screw-head    | 50      | 22   | 28   | 44.0  | 56.0  |
...
* For non-academic work, please include the following attribution:
  ...
  > Screw Driving Dataset - s03_variations-in-assembly-conditions-1 by Nikolai West @ RIF/IPS; Source: https://github.com/nikolaiwest/pyscrew; DOI: 10.5281/zenodo.15123922
